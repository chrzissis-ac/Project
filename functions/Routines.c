...
void menushow(int * input){
	...
	printf("7-\"L\" Print Solutions\n");
	printf("8-\"I\" Print Real and Complex Solutions\n");
	printf("9-\"T\" to terminate\n");
	...
	else if(strcmp(temp,"L\n")==0 || strcmp(temp,"L")==0 || strcmp(temp,"l\n")==0 || strcmp(temp,"l")==0){
		*input=-8;
	}
	else if(strcmp(temp,"I\n")==0 || strcmp(temp,"I")==0 || strcmp(temp,"i\n")==0 || strcmp(temp,"i")==0){
		*input=-9;
	}
